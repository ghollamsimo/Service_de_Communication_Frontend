...
const ChatComponent: React.FC = () => {
    return (
        <div className="grid w-full h-full">
            ...
            <div className="p-6 flex justify-between align-bottom items-end">
                ...
                <div className='w-full'>
                    ...
                    <div className={'flex gap-3'}>
                        <button className={'bg-white shadow-xl text-lg text-[#1B0036] p-4 rounded-full'} type='button'>
                            <IoSend/>
                        </button>

                        <button className={'bg-[#1B0036] text-lg text-white p-4 rounded-full'} type='button'>
                            <TiMicrophone />
                        </button>
                    </div>
                </div>
